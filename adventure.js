...
while(replay == true)
{
    while(alive == true)
    {
        ...
        if(answerOne == "a")
        {
            console.log(storyParts[2].textThreeOne);
        } else if(answerOne == "b")
        {
            console.log(storyParts[1].textTwo);
            let answerTwo = input.question("a. do it for free anyway \nb. accept the money \n");
            if(answerTwo == "a" || answerTwo == "b")
            {
                console.log(storyParts[2].textThreeOne);
            }
        } 
        let answerThreeOne = input.question("Press a to enter the cave. ");
        if(answerThreeOne == "a")
        {
            console.log(storyParts[3].textThreeTwo);
        }
        let answerThreeTwo = input.question("a. left \nb. right \n");
        if(answerThreeTwo == "a")
        {
            console.log("left");
        } else if (answerThreeTwo == "b")
        {
            console.log("right");
        }
        replay = false;
